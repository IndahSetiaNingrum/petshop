                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach ($admins as $admin) : ?>
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <a href="<?= base_url("kelola-admin/ubah/" . $admin["admin_id"]) ?>" class="btn btn-icon btn-warning">
                                                                <i class="far fa-edit"></i>
                                                            </a>
                                                            <a href="<?= base_url("kelola-admin/hapus/" . $admin["admin_id"]) ?>" class="btn btn-icon btn-danger button-delete">
